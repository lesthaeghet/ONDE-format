...
`ONDE_2DCAD`, `ONDE_3DCAD`, `ONDE_WELD`.
...
The two values indicate the inspected component longitudinal and shear wave
velocity respectively. If a velocity is unavailable, replace with NaN.
...
In the planar coordinate system, the z direction corresponds to the thickness.
...
In the cylindrical coordinate system, the x direction corresponds to the
cylinder axis.
