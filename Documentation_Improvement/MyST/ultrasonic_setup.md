...
These contain HDF5 references to the groups (of type {ref}`ONDE_UT_LAW`)
which provide the detailed description of each focal law.
...
The cardinality of the transmission and reception can be either:
