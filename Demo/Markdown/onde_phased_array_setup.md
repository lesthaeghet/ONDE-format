...
- full_name: ONDE:TYPE
  ...
  description: ''
  allowed_values: '["ONDE_PHASED_ARRAY_SETUP"]'
- full_name: ONDE_PHASED_ARRAY_SETUP:EMITTER_PROBE
  short_name: EMITTER_PROBE
  required: true
  storage: attribute
  hdf5_type: H5T_STD_REF_OBJ
  description: ''
  dimensions: '1'
- full_name: ONDE_PHASED_ARRAY_SETUP:RECEIVING_PROBE
  short_name: RECEIVING_PROBE
  required: true
  storage: attribute
  hdf5_type: H5T_STD_REF_OBJ
  description: ''
  dimensions: '1'
- full_name: ONDE_PHASED_ARRAY_SETUP:SEQUENCE_ANGLE_MODE
  short_name: SEQUENCE_ANGLE_MODE
  required: true
  storage: attribute
