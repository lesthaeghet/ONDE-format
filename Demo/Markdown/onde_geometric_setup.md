...
- full_name: ONDE_GEOMETRIC_SETUP:ACQUISITION_TRAJECTORY
  short_name: ACQUISITION_TRAJECTORY
  required: true
  storage: dataset
  hdf5_type: H5T_STD_REF_OBJ
...
- full_name: ONDE_GEOMETRIC_SETUP:PROBE_COORDINATE_FRAME
  short_name: PROBE_COORDINATE_FRAME
  required: false
  storage: dataset
  hdf5_type: H5T_FLOAT
