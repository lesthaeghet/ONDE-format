...
- full_name: ONDE_COMPONENT:VISUALIZATION_CAD_FRAME
  short_name: VISUALIZATION_CAD_FRAME
  required: false
  storage: attribute
  hdf5_type: H5T_FLOAT
...
- full_name: ONDE_COMPONENT:COMPONENT_FRAME
  ...
  dimensions: '[7]'
- full_name: ONDE_COMPONENT:COMMENT
  short_name: COMMENT
  required: false
  storage: attribute
  hdf5_type: H5T_STRING
