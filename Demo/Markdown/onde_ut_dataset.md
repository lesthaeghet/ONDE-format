...
- full_name: ONDE:TYPE
  ...
  description: ''
  dimensions: '[1]'
  allowed_values: '["ONDE_UT_DATASET"]'
- full_name: ONDE:LABEL
  ...
  description: ''
  dimensions: '1'
- full_name: ONDE_UT_DATASET:SETUP
  short_name: SETUP
  required: true
  storage: attribute
  hdf5_type: H5T_STD_REF_OBJ
  description: ''
  ref_target: ONDE_SETUP
  dimensions: '1'
- full_name: ONDE_UT_DATASET:OPERATOR
  short_name: OPERATOR
  required: false
  storage: attribute
  hdf5_type: H5T_STRING
  description: ''
  dimensions: '1'
- full_name: ONDE_UT_DATASET:DATE_AND_TIME
  short_name: DATE_AND_TIME
  required: false
  storage: attribute
  hdf5_type: H5T_STRING
  description: ''
