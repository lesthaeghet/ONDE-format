...
|---|---|---|---|---|---|---|
| [**`TYPE`**](#onde_component-type)<br><sub>`ONDE:TYPE`</sub> | Mandatory | attribute | H5T_STRING | `` | `["ONDE_COMPONENT"]` |  |
| [**`LABEL`**](#onde_component-label)<br><sub>`ONDE:LABEL`</sub> | Optional | attribute | H5T_STRING | `` | `` |  |
| [**`VELOCITIES`**](#onde_component-velocities)<br><sub>`ONDE_COMPONENT:VELOCITIES`</sub> | Mandatory | attribute | H5T_FLOAT | `[2]` | `` | The two values of the VELOCITIES array indicate the inspected component longitudinal and shear wave velocity respectively. |
| [**`DENSITY`**](#onde_component-density)<br><sub>`ONDE_COMPONENT:DENSITY`</sub> | Optional | attribute | H5T_FLOAT | `1` | `` |  |
| [**`VISUALIZATION_CAD`**](#onde_component-visualization_cad)<br><sub>`ONDE_COMPONENT:VISUALIZATION_CAD`</sub> | Optional | attribute | H5T_STRING | `1` | `` | VISUALISATION_CAD contains a DXF or STL file for the component visualization. |
| [**`VISUALIZATION_CAD_FRAME`**](#onde_component-visualization_cad_frame)<br><sub>`ONDE_COMPONENT:VISUALIZATION_CAD_FRAME`</sub> | Optional | attribute | H5T_FLOAT | `[7]` | `` | Definition of the frame defining the visualisation CAD with offset and quaternions in the specimen frame- Identity is used if absent |
| [**`COMPONENT_FRAME`**](#onde_component-component_frame)<br><sub>`ONDE_COMPONENT:COMPONENT_FRAME`</sub> | Optional | attribute | H5T_FLOAT | `[7]` | `` | The global coordinate system is distinct from the specimen coordinate system: 2D and 3D CAD coordinates are defined in the specimen frame and repositioned in the global coordinate system with the transformation defined in COMPONENT_FRAME. |
| [**`COMMENT`**](#onde_component-comment)<br><sub>`ONDE_COMPONENT:COMMENT`</sub> | Optional | attribute | H5T_STRING | `1` | `` |  |
| [**`IMAGE`**](#onde_component-image)<br><sub>`ONDE_COMPONENT:IMAGE`</sub> | Optional | attribute | H5T_FLOAT | `[3]` | `` |  |
