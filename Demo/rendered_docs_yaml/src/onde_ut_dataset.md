...
classDiagram
  ...
  ONDE_UT_DATASET o-- ONDE_SETUP : ONDE_UT_DATASET:SETUP
...
|---|---|---|---|---|---|---|
| [**`TYPE`**](#onde_ut_dataset-type)<br><sub>`ONDE:TYPE`</sub> | Mandatory | attribute | H5T_STRING | `[1]` | `["ONDE_UT_DATASET"]` |  |
| [**`LABEL`**](#onde_ut_dataset-label)<br><sub>`ONDE:LABEL`</sub> | Optional | attribute | H5T_STRING | `1` | `` |  |
| [**`SETUP`**](#onde_ut_dataset-setup)<br><sub>`ONDE_UT_DATASET:SETUP`</sub> | Mandatory | attribute | H5T_STD_REF_OBJ<[ONDE_SETUP](onde_setup.md)> | `1` | `` |  |
| [**`OPERATOR`**](#onde_ut_dataset-operator)<br><sub>`ONDE_UT_DATASET:OPERATOR`</sub> | Optional | attribute | H5T_STRING | `1` | `` |  |
| [**`DATE_AND_TIME`**](#onde_ut_dataset-date_and_time)<br><sub>`ONDE_UT_DATASET:DATE_AND_TIME`</sub> | Optional | attribute | H5T_STRING | `1` | `` |  |


## Field Details

(onde_ut_dataset-type)=
### `TYPE`

*No detailed description provided.*

(onde_ut_dataset-label)=
### `LABEL`

*No detailed description provided.*

(onde_ut_dataset-setup)=
### `SETUP`

*No detailed description provided.*

(onde_ut_dataset-operator)=
### `OPERATOR`

*No detailed description provided.*

(onde_ut_dataset-date_and_time)=
### `DATE_AND_TIME`
